...
<body>
    ...
    <nav class="navbar" style="background: #e9e2ec; width: 244px; position: absolute; height: 100%;">
        <div class="form position-absolute" style="top: 87px; left: 13px;">
            <form class="d-list" action="index.php">
                <button class="mt-2" style="width: 90px; height: 30px;">Flights</button>
                <br>
                <button class="mt-2" style="width: 90px;height: 30px;">Itenerary</button>
                <br>
                <button class="mt-2" style="width: 90px;height: 30px;">Home</button>
                <br>
                <button class="mt-2" style="width: 90px;height: 30px;">Sign off</button> 
            </form>
        </div>
    </nav>
